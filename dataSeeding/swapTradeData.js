...
const swapTradeDataFields = [
  ...
  "nearSellAmount",
  "nearExchangeRate",
  "nearBuyNostroAccountId",
  "nearBuyNostroAccountDescription",
  "nearSellNostroAccountId",
  "nearSellNostroAccountDescription",
  "farTradeId",
  "farSettlementDate",
  "farBuyCurrency",
  "farSellCurrency",
  ...
  "farSellAmount",
  "farExchangeRate",
  "farBuyNostroAccountId",
  "farBuyNostroAccountDescription",
  "farSellNostroAccountId",
  "farSellNostroAccountDescription",
];
...
const initialswapTradeData = [
  {
    ...
    nearSettlementDate: "2025-01-31",
    nearBuyCurrency: "GBP",
    nearSellCurrency: "USD",
    nearBuyAmount: 1000000,
    nearSellAmount: 1262000,
    nearExchangeRate: 1.262,
    nearBuyNostroAccountId: "001",
    nearBuyNostroAccountDescription: "Barclays Bank, London",
    nearSellNostroAccountId: "010",
    nearSellNostroAccountDescription: "Bank of America, New York",
    farTradeId: "SWAP-002-001-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "USD",
    farSellCurrency: "GBP",
    farBuyAmount: 1262300,
    farSellAmount: 1000000,
    farExchangeRate: 1.2623,
    farBuyNostroAccountId: "010",
    farBuyNostroAccountDescription: "Bank of America, New York",
    farSellNostroAccountId: "001",
    farSellNostroAccountDescription: "Barclays Bank, London",
  },
  {
    ...
    nearSettlementDate: "2025-01-31",
    nearBuyCurrency: "USD",
    nearSellCurrency: "JPY",
    nearBuyAmount: 1000000,
    nearSellAmount: 147220000,
    nearExchangeRate: 147.22,
    nearBuyNostroAccountId: "010",
    nearBuyNostroAccountDescription: "Bank of America, New York",
    nearSellNostroAccountId: "036",
    nearSellNostroAccountDescription: "Mizuho Bank, Tokyo",
    farTradeId: "SWAP-003-002-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "JPY",
    farSellCurrency: "USD",
    farBuyAmount: 147225000,
    farSellAmount: 1000000,
    farExchangeRate: 147.225,
    farBuyNostroAccountId: "036",
    farBuyNostroAccountDescription: "Mizuho Bank, Tokyo",
    farSellNostroAccountId: "010",
    farSellNostroAccountDescription: "Bank of America, New York",
  },
  {
    ...
    nearSellCurrency: "USD",
    nearBuyAmount: 1000000,
    nearSellAmount: 639000,
    nearExchangeRate: 0.639,
    nearBuyNostroAccountId: "026",
    nearBuyNostroAccountDescription: "Commonwealth Bank of Australia, Sydney",
    nearSellNostroAccountId: "010",
    nearSellNostroAccountDescription: "Bank of America, New York",
    farTradeId: "SWAP-004-003-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "USD",
    farSellCurrency: "AUD",
    farBuyAmount: 639300,
    farSellAmount: 1000000,
    farExchangeRate: 0.6393,
    farBuyNostroAccountId: "010",
    farBuyNostroAccountDescription: "Bank of America, New York",
    farSellNostroAccountId: "026",
    farSellNostroAccountDescription: "Commonwealth Bank of Australia, Sydney",
  },
  {
    ...
    nearSellCurrency: "USD",
    nearBuyAmount: 1000000,
    nearSellAmount: 593500,
    nearExchangeRate: 0.5935,
    nearBuyNostroAccountId: "034",
    nearBuyNostroAccountDescription: "Westpac New Zealand, Wellington",
    nearSellNostroAccountId: "010",
    nearSellNostroAccountDescription: "Bank of America, New York",
    farTradeId: "SWAP-005-004-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "USD",
    farSellCurrency: "NZD",
    farBuyAmount: 593800,
    farSellAmount: 1000000,
    farExchangeRate: 0.5938,
    farBuyNostroAccountId: "010",
    farBuyNostroAccountDescription: "Bank of America, New York",
    farSellNostroAccountId: "034",
    farSellNostroAccountDescription: "Westpac New Zealand, Wellington",
  },
  {
    ...
    nearSettlementDate: "2025-01-31",
    nearBuyCurrency: "EUR",
    nearSellCurrency: "GBP",
    nearBuyAmount: 1000000,
    nearSellAmount: 865400,
    nearExchangeRate: 0.8654,
    nearBuyNostroAccountId: "016",
    nearBuyNostroAccountDescription: "Deutsche Bank, Frankfurt",
    nearSellNostroAccountId: "001",
    nearSellNostroAccountDescription: "Barclays Bank, London",
    farTradeId: "SWAP-006-005-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "GBP",
    farSellCurrency: "EUR",
    farBuyAmount: 865600,
    farSellAmount: 1000000,
    farExchangeRate: 0.8656,
    farBuyNostroAccountId: "001",
    farBuyNostroAccountDescription: "Barclays Bank, London",
    farSellNostroAccountId: "016",
    farSellNostroAccountDescription: "Deutsche Bank, Frankfurt",
  },
  {
    ...
    nearSellCurrency: "JPY",
    nearBuyAmount: 1000000,
    nearSellAmount: 185125000,
    nearExchangeRate: 185.125,
    nearBuyNostroAccountId: "001",
    nearBuyNostroAccountDescription: "Barclays Bank, London",
    nearSellNostroAccountId: "036",
    nearSellNostroAccountDescription: "Mizuho Bank, Tokyo",
    farTradeId: "SWAP-007-006-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "JPY",
    farSellCurrency: "GBP",
    farBuyAmount: 185130000,
    farSellAmount: 1000000,
    farExchangeRate: 185.13,
    farBuyNostroAccountId: "036",
    farBuyNostroAccountDescription: "Mizuho Bank, Tokyo",
    farSellNostroAccountId: "001",
    farSellNostroAccountDescription: "Barclays Bank, London",
  },
  {
    ...
    nearSettlementDate: "2025-01-31",
    nearBuyCurrency: "USD",
    nearSellCurrency: "CAD",
    nearBuyAmount: 1000000,
    nearSellAmount: 1347800,
    nearExchangeRate: 1.3478,
    nearBuyNostroAccountId: "010",
    nearBuyNostroAccountDescription: "Bank of America, New York",
    nearSellNostroAccountId: "037",
    nearSellNostroAccountDescription: "Royal Bank of Canada, Ontario",
    farTradeId: "SWAP-008-007-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "CAD",
    farSellCurrency: "USD",
    farBuyAmount: 1348100,
    farSellAmount: 1000000,
    farExchangeRate: 1.3481,
    farBuyNostroAccountId: "037",
    farBuyNostroAccountDescription: "Royal Bank of Canada, Ontario",
    farSellNostroAccountId: "010",
    farSellNostroAccountDescription: "Bank of America, New York",
  },
  {
    ...
    nearSellCurrency: "USD",
    nearBuyAmount: 1000000,
    nearSellAmount: 1093400,
    nearExchangeRate: 1.0934,
    nearBuyNostroAccountId: "016",
    nearBuyNostroAccountDescription: "Deutsche Bank, Frankfurt",
    nearSellNostroAccountId: "010",
    nearSellNostroAccountDescription: "Bank of America, New York",
    farTradeId: "SWAP-009-008-FAR",
    farSettlementDate: "2025-03-01",
    farBuyCurrency: "USD",
    farSellCurrency: "EUR",
    farBuyAmount: 1093600,
    farSellAmount: 1000000,
    farExchangeRate: 1.0936,
    farBuyNostroAccountId: "010",
    farBuyNostroAccountDescription: "Bank of America, New York",
    farSellNostroAccountId: "016",
    farSellNostroAccountDescription: "Deutsche Bank, Frankfurt",
